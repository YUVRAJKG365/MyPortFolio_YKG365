...
.modal-video-container:hover .restart-video-btn {
    opacity: 1;
}
...
@media (max-width: 768px) {
    ...
    /* Ensure project/experience/certification cards are visible */
    .project-card, .certificate-card, .mobile-timeline-item {
        opacity: 1 !important;
    ...
    /* Ensure close button is visible in modals */
    ...
    /* Ensure blur effect works on mobile */
    .project-modal,
    .experience-modal,
    .resume-modal {
