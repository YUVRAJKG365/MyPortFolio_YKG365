...
function validateForm() {
    ...
    return true;
        ...
        //     formMessage.style.bottom = "20px";
        //     formMessage.style.left = "50%";
        //     formMessage.style.transform = "translateX(-50%)";
        //     formMessage.style.backgroundColor = "rgba(106, 17, 203, 0.9)";
        //     formMessage.style.color = "white";
        //     formMessage.style.padding = "15px 30px";
        //     formMessage.style.borderRadius = "50px";
        //     formMessage.style.zIndex = "1000";
        //     formMessage.style.boxShadow = "0 5px 15px rgba(0, 0, 0, 0.3)";
        //     document.body.appendChild(formMessage);

        //     // Simulate sending data (in a real scenario, you would use a server here)
        //     const formData = {
